...
class HelpPage(commands.Cog):  # Baseclass quasi Gerüst
    ...
    async def spieler_help(self, ctx):
        ...
        discord.Embed.add_field(spielerhelp1,
                                name="/tasche",
                                value="Schau was du alles in deinen Taschen verstaut hast.")

        discord.Embed.add_field(spielerhelp1,
                                name="/waffen_geben",
                                value="Gib einem Spieler etwas zum Verteidigen. Nicht, dass er noch stirbt.")
        discord.Embed.add_field(spielerhelp1,
                                name="/medizin_geben",
    ...
    async def gm_help(self, ctx):
        ...
        gmhelp2 = discord.Embed(title="Game Master Help", color=discord.Color.dark_purple())
        discord.Embed.add_field(gmhelp2, name="/add_medizin",
                                value="Füge Medizin / Gift dem Spielerinventar hinzu.")
        discord.Embed.add_field(gmhelp2, name="/lose_medizin",
                                value="Nehme Medizin / Gift aus dem Spielerinventar.")

        gmhelp3 = discord.Embed(title="Game Master Help", color=discord.Color.dark_purple())
        ...
        discord.Embed.add_field(gmhelp3, name="/lose_nahrung",
                                value="Nehme ein Nahrungsmittel aus dem Spielerinventar.")

        gmhelp4 = discord.Embed(title="Game Master Help", color=discord.Color.dark_purple())
        discord.Embed.add_field(gmhelp4, name="/add_schatz", value="Füge ein Schatz dem Spielerinventar hinzu.")
        discord.Embed.add_field(gmhelp4, name="/lose_schatz",
                                value="Nehme ein Schatz aus dem Spielerinventar, auch wenn es den Befehl  noch garnicht gibt.")

        gmhelp5 = discord.Embed(title="Game Master Help", color=discord.Color.dark_purple())
        discord.Embed.add_field(gmhelp5, name="/add_crafting",
                                value="Füge ein Crafting Utensil dem Spielerinventar hinzu.")
        discord.Embed.add_field(gmhelp5, name="/lose_crafting",
                                value="Nehme ein Crafting Utensil aus dem Spielerinventar.")

        gmhelp6 = discord.Embed(title="Game Master Help", color=discord.Color.dark_purple())
